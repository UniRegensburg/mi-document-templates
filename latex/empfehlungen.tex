\section{Empfehlungen für empirische Arbeiten}\label{sec:empfehlungen}

\subsection{Handbücher}\label{subsec:handbücher}
...
\subsection{Darstellung der Ergebnisse}\label{subsec:darstellung}
...
Je nach Ausführlichkeit und Zahl der Beobachtungen kann der Abschnitt Befunde nach einzelnen Problemen (als Überschriften) oder nach Aufgaben bzw. Szenarien in denen die Probleme auftraten organsisiert werden. Anregungen für die Gestaltung von Usability Reports bieten auch viele online verfügbare Templates (i.e. \cite[]{affairs_home_2013}, Abschnitt Templates)
