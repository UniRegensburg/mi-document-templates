\usection{Anhang B: Tipps für \LaTeX}\label{latex}
...
\usubsection{Struktur des Templates}
...
\usubsection{Wichtige Befehle}

\usubsubsection{Sections, Subsections, etc.}
...
\textbf{\large{Nummerierte Aufzählung}}
...
Unterpunkte können erstellt werden, indem innerhalb einer Liste eine neue Liste erstellt wird:
...
\usubsubsection{Abbildungen, Tabellen und Code}

\textbf{\large{Abbildungen}}
...
Dieses Template enthält jedoch eine Funktion, die dieses Kontrukt auf einen Einzeiler reduziert:
...
\image{schwammerl}{Bildbeschreibung}

\textbf{\large{Tabellen}}
