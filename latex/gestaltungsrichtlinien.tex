...
\subsubsection{Direkte Zitate}\label{subsubsec:direkte}\index{Direkte Zitate}
...
\subsubsection{Indirekte Zitate}\label{subsubsec:indirekte}\index{Indirekte Zitate}
...
\subsubsection{Sekundäre Zitate}\label{subsubsec:sekundäre}\index{Sekundäre Zitate}
...
\subsubsection{Zitierweise im Text}\label{subsubsec:zitierweise}\index{Zitierweise im Text}
